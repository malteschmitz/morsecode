...
\tikzset{
  ...
  grow'=right,
  level/.style={
    sibling distance={2^max(5-#1,0)*3ex}
  },
...
\begin{document}
  ...
  \section{Geschichte}
    ...
    mit dem auch Buchstaben codiert werden können, wurde ein Jahr später
    ...
    Telegrafenkongress in Paris standardisiert und später mit
  ...
  \section{Striche und Punkte}
    ...
    Buchstabens und Ziffern codiert, sodass sie durch Ein- und Ausschalten
  ...
  \section{Codetabelle}
    ...
    \begin{minipage}[t]{.44\textwidth}
      \subsection{Vorstand}
      \textbf{\large Kurt Wittman, DL2LAY}\\
      Ortsverbandsvorsitzender (OVV)\\[1ex]
      \textbf{\large Karl-Heinz Schmitz, DB7BN}\\
      Stellvertretender OVV
      
      \subsection{OV-Frequenzen}
      Eine gute Chance uns per Funk zu erreichen
      besteht auf den folgenden Frequenzen\\[1ex]
    ...
    \begin{minipage}[t]{.5\textwidth}
      ...
      freuen uns über jede E-Mail an\\[1ex]
      \begin{large}\bfseries
